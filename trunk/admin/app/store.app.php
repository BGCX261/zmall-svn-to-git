...
{
    var $_store_mod;
    var $_zhipping_mod; //Add by MingFONG for Zhipping at 2014-09-19
	...
	$this->_zhipping_mod =& m('zhipping'); //Add by MingFONG for Zhipping at 2014-09-19
    }
    ...
    function add()
    {
        ...
        if (!IS_POST)
        {
			...
			$this->assign('is_zeuz_options', array(
                '1' => Lang::get('yes'),
                '0' => Lang::get('no'),
            ));
			//End of MingFONG
        ...
        else
        {
			...
			$_is_zeuz = array(
				'store_id' => $user_id,
				'is_zeuz' => $_POST['is_zeuz'],
			);
			if ($this->_zhipping_mod->add($_is_zeuz) === false)
            {
                $this->show_warning($this->_zhipping_mod->get_error());
                return false;
            }
			//End of MingFONG
    ...
    function edit()
    {
        ...
        if (!IS_POST)
        {
			...
			//Add by MingFONG for Zhipping at 2014-09-19
			$zhipping = $this->_zhipping_mod->get(
            array(
			...
			$store['is_zeuz'] = $zhipping['is_zeuz'];
			//print_r($zhipping);
        ...
        else
        {
			...
			$this->_zhipping_mod->edit($id, $_is_zeuz);
			//End of MingFONG
