...
class StoreApp extends StorebaseApp
{
    ...
    function _get_recommended_goods($id, $num = 12)
    {
        ...
        $goods_list = $goods_mod->find(array(
            ...
            'fields'     => 'goods_name, default_image, g.price, cate_id_1,spec_id',//Add cate_id_1 by MingFONG for clothing style at 2014-09-22
            'limit'      => $num,
        ));
        ...
        foreach ($goods_list as $key => $goods)
        {
			...
			//Add by MingFONG for clothing style at 2014-09-22
			if ($goods['cate_id_1'] == 21 || $goods['cate_id_1'] == 272){
